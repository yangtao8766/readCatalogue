(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('path'), require('node:url'), require('node:path'), require('node:fs'), require('node:fs/promises'), require('node:events'), require('node:stream'), require('node:string_decoder')) :
    typeof define === 'function' && define.amd ? define(['exports', 'fs', 'path', 'node:url', 'node:path', 'node:fs', 'node:fs/promises', 'node:events', 'node:stream', 'node:string_decoder'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.readCatalogue = {}, global.fs, global.path, global.node_url, global.node_path, global.actualFS, global.promises, global.node_events, global.Stream, global.node_string_decoder));
})(this, (function (exports, fs, path$1, node_url, node_path, actualFS, promises, node_events, Stream, node_string_decoder) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /* c8 ignore start */
    const defaultPlatform$2 = (typeof browser$1 === 'object' && browser$1
        ? (typeof browser$1.env === 'object' &&
            browser$1.env &&
            browser$1.env.__MINIMATCH_TESTING_PLATFORM__) ||
            browser$1.platform
        : 'posix');
    const path = {
        win32: { sep: '\\' },
    ...
    /* c8 ignore start */
    const PROCESS = (typeof browser$1 === 'object' && !!browser$1 ? browser$1 : {});
    /* c8 ignore start */
    ...
    const proc = typeof browser$1 === 'object' && browser$1
        ? browser$1
        : {
            stdout: null,
            stderr: null,
    ...
    class PathScurryBase {
         ...
         * @internal
         */
        constructor(cwd = browser$1.cwd(), pathImpl, sep, { nocase, childrenCacheSize = 16 * 1024, fs = defaultFS, } = {}) {
    ...
    class PathScurryWin32 extends PathScurryBase {
         ...
         */
        sep = '\\';
        constructor(cwd = browser$1.cwd(), opts = {}) {
     ...
     */
    browser$1.platform === 'win32' ? PathWin32 : PathPosix;
    /**
     ...
     */
    const PathScurry = browser$1.platform === 'win32' ? PathScurryWin32
        : browser$1.platform === 'darwin' ? PathScurryDarwin
            : PathScurryPosix;
    ...
    const defaultPlatform$1 = (typeof browser$1 === 'object' &&
        browser$1 &&
        typeof browser$1.platform === 'string') ?
        browser$1.platform
        : 'linux';
    /**
    ...
    const defaultPlatform = (typeof browser$1 === 'object' &&
        browser$1 &&
        typeof browser$1.platform === 'string') ?
        browser$1.platform
        : 'linux';
        ...
        for (let i = 0; i < option.hierarchy; i++) {
          md = yield glob(`${mdname}${option.ext}`, {
            ignore: {
              ignored: p => {
                var _a;
                return Boolean((_a = option.regexp) === null || _a === undefined ? undefined : _a.test(p.name));
              },
