(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node:url'), require('node:path'), require('fs'), require('node:fs'), require('node:fs/promises'), require('node:events'), require('node:stream'), require('node:string_decoder'), require('path')) :
    typeof define === 'function' && define.amd ? define(['exports', 'node:url', 'node:path', 'fs', 'node:fs', 'node:fs/promises', 'node:events', 'node:stream', 'node:string_decoder', 'path'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.readCatalogue = {}, global.node_url, global.node_path, global.fs, global.actualFS, global.promises, global.node_events, global.Stream, global.node_string_decoder, global.path));
})(this, (function (exports, node_url, node_path, fs, actualFS, promises, node_events, Stream, node_string_decoder, path$1) { 'use strict';
...
//# sourceMappingURL=chunk-index-CM1HHon1.umd.js.map
